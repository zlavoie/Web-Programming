...
class OutboxView:
    def redirectRead(self,email):
        ...
        print "<h1 class='inbox'>Outbox Message</h1>"
        print "</div>"
        print "<br>"
        ...
        print "</textarea>"
        print "<br>"
        print "<input type='submit' class='inbox' name='back' formaction='outboxcontroller.py' value='Back To Outbox'/>"
...
# first time on this page
    def view(self,emails,userid):
        ...
        print "<head>"
        print "<link rel='stylesheet' type='text/css' href='./css/main.css'>"
        print "<title>Outbox</title>"
        print "</head>"
        print "<html>"
        print "<body class='inbox'>"
        print "<br>"
        print "<div class='outter'>"
        print "<h1 class='inbox'>Outbox</h1>"
        print "</div>"
        print "<br>"
